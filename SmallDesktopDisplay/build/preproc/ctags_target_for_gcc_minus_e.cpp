# 1 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino"
/* *****************************************************************
 * 
 * SmallDesktopDisplay
 *    小型桌面显示器
 ...
 *  库文件、头文件
 * *****************************************************************/
# 37 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 38 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 39 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 40 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 41 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 42 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 43 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 44 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 45 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 46 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 47 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 48 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 49 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
...
# 72 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
//WiFiManager 参数
...
# 79 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2


DHT dht(12,11 /**< DHT TYPE 11 */);
 ...
 *  字库、图片库
 * *****************************************************************/
# 92 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 93 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 94 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 95 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2


# 98 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 99 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 100 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 101 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 102 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 103 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 104 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 105 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 106 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
# 107 "/Users/zhangbo/AirmoleProject/sd2-display-clock/SmallDesktopDisplay/SmallDesktopDisplay.ino" 2
...
void loading(byte delayTime)//绘制进度条
{
  ...
  clk.setTextDatum(4 /* Centre centre, same as above*/); //设置文本数据
  clk.setTextColor(0x07E0 /*   0, 255,   0 */, 0x0000);
  clk.drawString("Connecting to WiFi......",100,40,2);
  clk.setTextColor(0xFFFF /* 255, 255, 255 */, 0x0000);
  clk.drawRightString("SDD V1.4",180,60,2);
...
void IndoorTem()
{
  ...
  clk.setTextDatum(4 /* Centre centre, same as above*/);
  clk.setTextColor(0xFFFF /* 255, 255, 255 */, bgColor);
  ...
  if(Serial.available()>0)
  {
    ...
    if(SMOD=="0x01")//设置1亮度设置
    {
      ...
      if(LCDBL>=0 && LCDBL<=100)
      {
        ...
        SMOD = "";
        Serial.printf("亮度调整为：");
        analogWrite(5 /*LCD背光引脚*/, 1023 - (LCD_BL_PWM*10));
...
void handleconfig()
{
  ...
  String content = "<html><style>html,body{ background: #1aceff; color: #fff; font-size: 10px;}</style>";
        ...
        content += "<br>DHT Sensor Enable  <input type='radio' name='web_DHT11_en' value='0'checked> DIS                                           <input type='radio' name='web_DHT11_en' value='1'> EN<br>";


        content += "<br>LCD Rotation<br>                    <input type='radio' name='web_set_rotation' value='0' checked> USB Down<br>                    <input type='radio' name='web_set_rotation' value='1'> USB Right<br>                    <input type='radio' name='web_set_rotation' value='2'> USB Up<br>                    <input type='radio' name='web_set_rotation' value='3'> USB Left<br>";




        content += "<br>Main UI<br>                    <input type='radio' name='web_set_mainui' value='0' checked>Weather<br>                    <input type='radio' name='web_set_mainui' value='1'>Birthday<br>";
...
void Webconfig()
{
  ...
  const char* set_rotation = "<br/><label for='set_rotation'>Set Rotation</label>                              <input type='radio' name='set_rotation' value='0' checked> One<br>                              <input type='radio' name='set_rotation' value='1'> Two<br>                              <input type='radio' name='set_rotation' value='2'> Three<br>                              <input type='radio' name='set_rotation' value='3'> Four<br>";
  ...
  const char* set_mainui = "<br/><label for='set_mainui'>main UI</label>                              <input type='radio' name='set_mainui' value='0' checked> weather<br>                              <input type='radio' name='set_mainui' value='1'> birthday<br>";
...
void setup()
{
 ...
 //从eeprom读取背光亮度设置
  ...
  tft.setRotation(LCD_Rotation);
  tft.fillScreen(0x0000);
  tft.setTextColor(0x0000 /*   0,   0,   0 */, bgColor);
  ...
  tft.fillScreen(0x0000 /*   0,   0,   0 */);//清屏
...
void biliData(String *jsonStr)
{
  ...
  if (sk["status"].as<String>() == "1") {
    clk.setTextColor(0x07E0 /*   0, 255,   0 */, bgColor);
  } else {
    clk.setTextColor(0xFFFF /* 255, 255, 255 */, bgColor);
  }
...
//  { 
    if(scrollText[currentIndex])
    {
      ...
      clkb.setTextDatum(4 /* Centre centre, same as above*/);
      clkb.setTextColor(0xFFFF /* 255, 255, 255 */, bgColor);
...
void digitalClockDisplay(int reflash_en, int yXis)
{
  ...
  if(Current_UI == 1) {
    ...
    clk.fillSprite(bgColor);
    clk.setTextDatum(4 /* Centre centre, same as above*/);
    clk.setTextColor(0xFFE0 /* 255, 255,   0 */, bgColor);
...
time_t getNtpTime()
{
  ...
  while (millis() - beginWait < 1500) {
    ...
    if (size >= NTP_PACKET_SIZE) {
      ...
      return secsSince1900 - 2208988800UL + timeZone * ((time_t)(3600UL));
    }
  }
